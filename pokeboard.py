...
with competition:\
    ...
    filtered_moves = filter_contest_moves_by_type(contest_moves, contest_choice)
            ...
            formatted_rows.append(
                {
                    ...
                    "Appeal": move["appeal"],
                    "Jam": move["jam"],
                    "Use After": ", ".join(use_after_list) if use_after_list else "None",
                    "Use Before": ", ".join(use_before_list) if use_before_list else "None",
                }
            )
